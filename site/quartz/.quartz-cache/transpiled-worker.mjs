...
var DEFAULT_MONO = '"Cascadia Code", "Cascadia Mono", "Courier New", ui-monospace, SFMono-Regular, SF Mono, Menlo, monospace';
...
import { Fragment as Fragment5, jsx as jsx27, jsxs as jsxs16 } from "preact/jsx-runtime";
...
var Backlinks_default = /* @__PURE__ */ __name(((opts) => {
  ...
  const Backlinks = /* @__PURE__ */ __name(({
    ...
    const isProfile = fileData.frontmatter?.type === "profile";
    const profileId = fileData.frontmatter?.ID;
    const basePath = pathToRoot(fileData.slug);
    const filteredBacklinkFiles = isProfile ? backlinkFiles.filter((file) => file.frontmatter?.type !== "profile") : backlinkFiles;
    const hasRegularBacklinks = filteredBacklinkFiles.length > 0;
    const hasChapterBacklinks = isProfile && profileId !== void 0;
    if (options2.hideWhenEmpty && !hasRegularBacklinks && !hasChapterBacklinks) {
      return null;
    }
...
// quartz/components/ProfileTabs.tsx
import { jsx as jsx37, jsxs as jsxs21 } from "preact/jsx-runtime";
var ProfileTabs_default = /* @__PURE__ */ __name((() => {
  const ProfileTabs = /* @__PURE__ */ __name(({ displayClass, fileData }) => {
    const profileId = fileData.frontmatter?.ID;
    const isProfile = fileData.frontmatter?.type === "profile";
    ...
    const basePath = pathToRoot(fileData.slug);
    return /* @__PURE__ */ jsxs21("div", { class: classNames(displayClass, "profile-tabs"), "data-profile-id": profileId, "data-base-path": basePath, children: [
      /* @__PURE__ */ jsxs21("div", { class: "tabs-header", children: [
        /* @__PURE__ */ jsx37("button", { class: "tab-button active", "data-tab": "biography", children: "\u{1F4D6} Background" }),
        /* @__PURE__ */ jsx37("button", { class: "tab-button", "data-tab": "media", id: "media-tab-button", style: "display: none;", children: "\u{1F5BC}\uFE0F Gallery" }),
        /* @__PURE__ */ jsx37("button", { class: "tab-button", "data-tab": "documents", id: "documents-tab-button", style: "display: none;", children: "\u{1F4C4} Documents" })
      ] }),
      /* @__PURE__ */ jsxs21("div", { class: "tabs-content", children: [
        /* @__PURE__ */ jsx37("div", { class: "tab-pane active", "data-tab-content": "biography" }),
        /* @__PURE__ */ jsx37("div", { class: "tab-pane", "data-tab-content": "media", children: /* @__PURE__ */ jsx37("div", { id: "media-content", children: /* @__PURE__ */ jsx37("div", { class: "loading-message", children: "Loading gallery..." }) }) }),
        /* @__PURE__ */ jsx37("div", { class: "tab-pane", "data-tab-content": "documents", children: /* @__PURE__ */ jsx37("div", { id: "documents-content", children: /* @__PURE__ */ jsx37("div", { class: "loading-message", children: "Loading documents..." }) }) })
      ] })
    ] });
  }, "ProfileTabs");
  ProfileTabs.css = `
...
// quartz/components/FamilyTreeLarge.tsx
...
var NavBar = /* @__PURE__ */ __name(({ fileData, cfg, displayClass }) => {
  const baseDir = pathToRoot(fileData.slug);
  return /* @__PURE__ */ jsx39("nav", { class: classNames(displayClass, "navbar"), children: /* @__PURE__ */ jsxs23("div", { class: "navbar-container", children: [
    /* @__PURE__ */ jsxs23("button", { class: "navbar-toggle", "aria-label": "Toggle navigation menu", children: [
      /* @__PURE__ */ jsx39("span", {}),
      /* @__PURE__ */ jsx39("span", {}),
      /* @__PURE__ */ jsx39("span", {})
    ] }),
    /* @__PURE__ */ jsxs23("ul", { class: "navbar-menu", children: [
      /* @__PURE__ */ jsx39("li", { children: /* @__PURE__ */ jsx39("a", { href: baseDir, children: "Home" }) }),
      /* @__PURE__ */ jsx39("li", { children: /* @__PURE__ */ jsx39("a", { href: joinSegments(baseDir, "pages/all-profiles"), children: "All Profiles" }) }),
      /* @__PURE__ */ jsx39("li", { children: /* @__PURE__ */ jsx39("a", { href: joinSegments(baseDir, "pages/profiles-of-interest"), children: "Profiles of Interest" }) }),
      /* @__PURE__ */ jsx39("li", { children: /* @__PURE__ */ jsx39("a", { href: joinSegments(baseDir, "pages/about"), children: "About" }) })
    ] })
  ] }) });
}, "NavBar");
NavBar.css = `
...
// quartz/components/AllImagesGallery.tsx
import { jsx as jsx40 } from "preact/jsx-runtime";
var AllImagesGallery_default = /* @__PURE__ */ __name((() => {
  const AllImagesGallery = /* @__PURE__ */ __name(({ displayClass, fileData }) => {
    const isAllImagesPage = fileData.slug === "pages/all-images";
    if (!isAllImagesPage) {
      return null;
    }
    const basePath = pathToRoot(fileData.slug);
    return /* @__PURE__ */ jsx40("div", { class: classNames(displayClass, "all-images-gallery"), id: "all-images-gallery-wrapper", "data-base-path": basePath, children: /* @__PURE__ */ jsx40("div", { id: "all-images-gallery-container", children: /* @__PURE__ */ jsx40("div", { class: "loading-message", children: "Loading all images..." }) }) });
  }, "AllImagesGallery");
...
var sharedPageComponents = {
  ...
  afterBody: [
    ...
    ConditionalRender_default({
      component: ProfileTabs_default(),
      condition: /* @__PURE__ */ __name((page) => page.fileData.frontmatter?.type === "profile", "condition")
    }),
    ConditionalRender_default({
      component: AllImagesGallery_default(),
      condition: /* @__PURE__ */ __name((page) => page.fileData.slug === "pages/all-images", "condition")
    })
  ],
